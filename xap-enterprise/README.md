...
WEBUI_PORT=8099
WEBSTER_HTTP_PORT=8250
JMX_REGISTRY_PORT=35323
ZOOKEEPER_CLIENT_PORT=2181
```
__Run with private/public ip and port forwarding (use above configuration)__
```

docker run --name test -it -e XAP_PUBLIC_HOST-e XAP_MANAGER_SERVERS -e XAP_LICENSE -p 8090:8090 -p 8099:8099 -p 4174:4174 -p 8200-8300:8200-8300 -p 2181:2181 -p 2888:2888 -p 3888:3888 gigaspaces/xap-enterprise host run-agent --manager --gsc=2
```
